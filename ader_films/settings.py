"""
Django settings for ader_films project.
...
SECRET_KEY = 'django-insecure-4t0zyy09v)436k1+fyb211&n^xbo7pn+3=@e9@b)bnro29$nt@'
...
WSGI_APPLICATION = 'ader_films.wsgi.application'
